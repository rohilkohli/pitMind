...
const MOCK_BATTLES: BattleCard[] = [
  ...
  },
  {
    ...
    lap: 28,
    narrative:
      "Tsunoda consolidates P9 as Bottas faces tyre graining issues. Gap stable, but Tsunoda pace advantage evident.",
  ...
  return (
    <div className="pm-panel" style={{ padding: 24 }}>
      <div className="mb-6">
        ...
        <p className="font-tele text-xs text-[var(--text-secondary)] mt-1">
          Live position battles and narrative highlights
        </p>
      </div>
          ...
          >
            ...
            <div className="mb-4">
              <div className="grid grid-cols-[1fr_1fr] gap-4 mb-3">
                ...
                <div className="text-center p-3 bg-[var(--carbon-mid)] border border-[var(--border)]">
                  <div className="font-label text-lg font-bold text-[var(--text-primary)] tracking-wide">
                    {battle.driver1.name}
                  </div>
                  <div className="font-race text-xs text-[var(--text-secondary)] mt-1">
                    P{battle.driver1.position}
                  </div>
                  <div className="font-tele text-xs text-[var(--f1-red)] mt-1">
                    #{battle.driver1.number}
                  </div>
                </div>
                ...
                <div className="text-center p-3 bg-[var(--carbon-mid)] border border-[var(--border)]">
                  ...
                  <div className="font-race text-xs text-[var(--text-secondary)] mt-1">
                    P{battle.driver2.position}
                  </div>
                  <div className="font-tele text-xs text-[var(--f1-red)] mt-1">
                    #{battle.driver2.number}
                  </div>
                </div>
              </div>
            ...
            {selectedId === battle.id && (
              <div className="mt-3 pt-3" style={{ borderTop: "1px solid var(--border)" }}>
                <p className="font-label tracking-wider text-xs text-[var(--f1-red)] font-semibold uppercase">
      ...
      <div className="mt-6 p-4 bg-[var(--carbon-mid)] border border-[var(--border)]">
        <p className="font-tele text-[10px] text-[var(--text-secondary)]">
          ...
          Click any battle card to follow that storyline in detail. Track position changes, gaps,
          and narrative arcs as they unfold lap by lap.
        </p>
      </div>
    </div>
  );
