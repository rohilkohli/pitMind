...
export function isLapPoint(value: unknown): value is LapPoint {
  ...
  return (
    ...
    (obj.lap_time_s === undefined ||
      obj.lap_time_s === null ||
      typeof obj.lap_time_s === "number") &&
    ...
    (obj.tyre_wear_pct === undefined ||
      obj.tyre_wear_pct === null ||
      typeof obj.tyre_wear_pct === "number") &&
    (obj.tyre_compound === undefined ||
      obj.tyre_compound === null ||
      typeof obj.tyre_compound === "string") &&
...
export function isDebriefResponse(value: unknown): value is DebriefResponse {
  ...
  return typeof obj.report_markdown === "string" && typeof obj.source_note === "string";
}
